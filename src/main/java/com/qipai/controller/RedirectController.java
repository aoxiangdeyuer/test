...
import com.qipai.util.HttpsUtil;
...
public class RedirectController {
    ...
    public static final String WX_APPID = "wx281669dc9164c874";
    
    public static final String WX_APPSECRET = "bba6c48f866d8ce912acd476a1188865";
    ...
    public String wecahtLogin(@RequestParam(name = "code", required = false) String code,
        ...
        if(code != null || !(code.equals(""))) {
            ...
            String REDIRECT_URI = "http://bb26a2cd.ngrok.io/wechat/portal";
            String SCOPE = "snsapi_userinfo";

            String getCodeUrl = WechatApplication.getCode(APPID, REDIRECT_URI, SCOPE);
            logger.info("第一步:用户授权, get Code URL:{}", getCodeUrl);

            // 替换字符串，获得请求access token URL
            String tokenUrl = WechatApplication.getWebAccess(APPID, SECRET, CODE);
...
//            }
            ...
            if (null != jsonObject) {
                try {
                    ...
                    // 3. 使用获取到的 Access_token 和 openid 拉取用户信息
                    String userMessageUrl = WechatApplication.getUserMessage(WebAccessToken, openId);
